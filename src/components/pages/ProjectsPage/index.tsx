...
import { DEVPOST_URL, GITEA_URL, GITHUB_URL, THYCK } from "@site/config/url";
    ...
    <Layout title="Projects" description="Charles Ancheta's Projects">
      <HeaderSection title="My Personal Projects" subtitle="Both alone and with ✨friends✨">
        <div className={clsx("centre-content", styles.buttons)}>
          <ExtLink to={GITHUB_URL} svg={GithubSvg} label="GitHub" />
          <ExtLink to={DEVPOST_URL} svg={DevpostSvg} label="Devpost" />
          <ExtLink to={GITEA_URL} svg={GiteaSvg} label="Gitea" />
        </div>
      </HeaderSection>
      <main>
